...
syn keyword vimCommand contained hi[ghlight] hid[e] his[tory] ho[rizontal] if ij[ump] il[ist] imp[ort] int[ro] inte[rface] is[earch] isp[lit] j[oin] ju[mps] k kee[pmarks] keepj[umps] keepp[atterns] keepa[lt] l[ist] lN[ext] lNf[ile] la[st] lab[ove] lan[guage] lad[dexpr] laddb[uffer] laddf[ile] laf[ter] lat[er] lb[uffer] lbe[fore] lbel[ow] lbo[ttom] lc[d] lch[dir] lcl[ose] lcs[cope] ld[o] le[ft] lefta[bove] lex[pr] leg[acy] lf[ile] lfd[o] lfir[st] lg[etfile] lgetb[uffer] lgete[xpr] lgr[ep] lgrepa[dd] lh[elpgrep] lhi[story] ll lla[st] lli[st] lmak[e] lne[xt] lnew[er] lnf[ile] lo[adview] loc[kmarks] lockv[ar] lol[der] lop[en] lp[revious] lpf[ile] lr[ewind] lt[ag] lv[imgrep] lvimgrepa[dd] lw[indow] ls m[ove] ma[rk] mak[e] marks menut[ranslate] mes[sages] mk[exrc] mks[ession]
syn keyword vimCommand contained mksp[ell] mkv[imrc] mkvie[w] mod[e] n[ext] nb[key] nbc[lose] nbs[tart] noa[utocmd] noh[lsearch] nos[wapfile] nu[mber] o[pen] ol[dfiles] on[ly] opt[ions] ow[nsyntax] p[rint] pa[ckadd] packl[oadall] pc[lose] ped[it] po[p] pp[op] pre[serve] prev[ious] pro[mptfind] promptr[epl] prof[ile] profd[el] ps[earch] pt[ag] ptN[ext] ptf[irst] ptj[ump] ptl[ast] ptn[ext] ptp[revious] ptr[ewind] pts[elect] pu[t] pub[lic] pw[d] q[uit] quita[ll] qa[ll] r[ead] rec[over] red[o] redi[r] redr[aw] redraws[tatus] redrawt[abline] reg[isters] res[ize] ret[ab] retu[rn] rew[ind] ri[ght] rightb[elow] ru[ntime] rub[y] rubyd[o] rubyf[ile] rund[o] rv[iminfo] sN[ext] sa[rgument] sal[l] san[dbox] sav[eas] sb[uffer] sbN[ext] sba[ll] sbf[irst] sbl[ast] sbm[odified]
syn keyword vimCommand contained sbn[ext] sbp[revious] sbr[ewind] sc[riptnames] scripte[ncoding] scriptv[ersion] scs[cope] setf[iletype] sf[ind] sfir[st] sh[ell] si[malt] sig[n] sil[ent] sla[st] sn[ext] so[urce] sor[t] sp[lit] spe[llgood] spelld[ump] spelli[nfo] spellr[epall] spellra[re] spellu[ndo] spellw[rong] spr[evious] sr[ewind] st[op] sta[g] star[tinsert] startg[replace] startr[eplace] stat[ic] stopi[nsert] stj[ump] sts[elect] sun[hide] sus[pend] sv[iew] sw[apname] synti[me] sync[bind] smi[le] t tN[ext] ta[g] tags tab tabc[lose] tabd[o] tabe[dit] tabf[ind] tabfir[st] tabm[ove] tabl[ast] tabn[ext] tabnew tabo[nly] tabp[revious] tabN[ext] tabr[ewind] tabs tc[d] tch[dir] te[aroff] ter[minal] tf[irst] thi[s] tj[ump] tl[ast] tn[ext] to[pleft] tp[revious] tr[ewind]
syn keyword vimCommand contained try ts[elect] ty[pe] u[ndo] undoj[oin] undol[ist] unh[ide] unlo[ckvar] uns[ilent] up[date] v[global] ve[rsion] verb[ose] vert[ical] vi[sual] vie[w] vim[grep] vimgrepa[dd] vim9[cmd] viu[sage] vne[w] vs[plit] w[rite] wN[ext] wa[ll] wh[ile] wi[nsize] winc[md] wind[o] winp[os] wn[ext] wp[revious] wq wqa[ll] wu[ndo] wv[iminfo] x[it] xa[ll] xr[estore] y[ank] z dl dell delel deletl deletel dp dep delp delep deletp deletep a i
...
syn cluster vimCmdList	contains=vimAbb,vimAddress,vimAutoCmd,vimAugroup,vimBehave,vimCall,vimCatch,vimConst,vimDef,vimDelcommand,@vimEcho,vimEnddef,vimEndfunction,vimExecute,vimIsCommand,vimExtCmd,vimFor,vimFunction,vimGlobal,vimHighlight,vimLet,vimLoadkeymap,vimMap,vimMark,vimMatch,vimNotFunc,vimNorm,vimSet,vimSleep,vimSyntax,vimThrow,vimUnlet,vimUnmap,vimUserCmd,vimMenu,vimMenutranslate,@vim9CmdList,vimLua,vimMzScheme,vimPerl,vimPython,vimRuby,vimTcl,vimEmbedError
...
if g:vimsyn_embed =~# 'l' && filereadable(s:luapath)
 ...
 VimFoldl syn region vimLuaRegion contained matchgroup=vimScriptHereDocStart start=+\%(^\z(\s*\)\S.*\)\@<=<<\s*trim\s\+\z(\S\+\)\ze\s*$+ matchgroup=vimScriptHereDocStop end=+^\z1\=\z2$+ contains=@vimLuaScript
 VimFoldl syn region vimLuaRegion contained matchgroup=vimScriptHereDocStart start=+\%(^\z(\s*\)\S.*\)\@<=<<\s*trim\ze\s*$+	           matchgroup=vimScriptHereDocStop end=+^\z1\=\.$+  contains=@vimLuaScript
else
...
if g:vimsyn_embed =~# 'm' && filereadable(s:mzschemepath)
 ...
 VimFoldm syn region vimMzSchemeRegion contained matchgroup=vimScriptHereDocStart start=+\%(^\z(\s*\)\S.*\)\@<=<<\s*trim\s\+\z(\S\+\)\ze\s*$+ matchgroup=vimScriptHereDocStop end=+^\z1\=\z2$+ contains=@vimMzSchemeScript
 VimFoldm syn region vimMzSchemeRegion contained matchgroup=vimScriptHereDocStart start=+\%(^\z(\s*\)\S.*\)\@<=<<\s*trim\ze\s*$+              matchgroup=vimScriptHereDocStop end=+^\z1\=\.$+  contains=@vimMzSchemeScript
else
...
if g:vimsyn_embed =~# 'p' && filereadable(s:perlpath)
 ...
 VimFoldp syn region vimPerlRegion contained matchgroup=vimScriptHereDocStart start=+\%(^\z(\s*\)\S.*\)\@<=<<\s*trim\s\+\z(\S\+\)\ze\s*$+ matchgroup=vimScriptHereDocStop end=+^\z1\=\z2$+ contains=@vimPerlScript
 VimFoldp syn region vimPerlRegion contained matchgroup=vimScriptHereDocStart start=+\%(^\z(\s*\)\S.*\)\@<=<<\s*trim\ze\s*$+	            matchgroup=vimScriptHereDocStop end=+^\z1\=\.$+  contains=@vimPerlScript
else
...
if g:vimsyn_embed =~# 'P' && filereadable(s:pythonpath)
 ...
 VimFoldP syn region vimPythonRegion contained matchgroup=vimScriptHereDocStart start=+\%(^\z(\s*\)\S.*\)\@<=<<\s*trim\s\+\z(\S\+\)\ze\s*$+ matchgroup=vimScriptHereDocStop end=+^\z1\=\z2$+ contains=@vimPythonScript
 VimFoldP syn region vimPythonRegion contained matchgroup=vimScriptHereDocStart start=+\%(^\z(\s*\)\S.*\)\@<=<<\s*trim\ze\s*$+              matchgroup=vimScriptHereDocStop end=+^\z1\=\.$+  contains=@vimPythonScript
else
...
if g:vimsyn_embed =~# 'r' && filereadable(s:rubypath)
 ...
 VimFoldr syn region vimRubyRegion contained matchgroup=vimScriptHereDocStart start=+\%(^\z(\s*\)\S.*\)\@<=<<\s*trim\s\+\z(\S\+\)\ze\s*$+ matchgroup=vimScriptHereDocStop end=+^\z1\=\z2$+ contains=@vimRubyScript
 VimFoldr syn region vimRubyRegion contained matchgroup=vimScriptHereDocStart start=+\%(^\z(\s*\)\S.*\)\@<=<<\s*trim\ze\s*$+	            matchgroup=vimScriptHereDocStop end=+^\z1\.$+  contains=@vimRubyScript
else
...
if g:vimsyn_embed =~# 't' && filereadable(s:tclpath)
 ...
 VimFoldt syn region vimTclRegion contained matchgroup=vimScriptHereDocStart start=+\%(^\z(\s*\)\S.*\)\@<=<<\s*trim\s\+\z(\S\+\)\ze\s*$+ matchgroup=vimScriptHereDocStop end=+^\z1\=\z2$+ contains=@vimTclScript
 VimFoldt syn region vimTclRegion contained matchgroup=vimScriptHereDocStart start=+\%(^\z(\s*\)\S.*\)\@<=<<\s*trim\ze\s*$+	           matchgroup=vimScriptHereDocStop end=+^\z1\=\.$+  contains=@vimTclScript
else
